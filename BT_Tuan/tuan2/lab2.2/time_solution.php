...
if($month=="1"||$month=="3"||$month=="5"||$month=="7"||$month=="8"||$month=="10"||$month=="12"){
	...
	if($day=="31"){echo "Ngày bạn chọn không tồn tại";}
	else{echo "You have choose to have an appointment on $hour:$min:$sec , $day/$month/$year";}
}elseif($month=="2"){
	if($day<="28"){echo "You have choose to have an appointment on $hour:$min:$sec , $day/$month/$year";}
	elseif($day=="30"||$day=="31"){echo "Ngày bạn chọn không tồn tại";}
	elseif($day=="29"){
		if($year%400=="0")
		{echo "You have choose to have an appointment on $hour:$min:$sec , $day/$month/$year";}
		else if(($year%"4"=="0")&&$year%"100")
		{echo "You have choose to have an appointment on $hour:$min:$sec , $day/$month/$year";}
		else{echo "Ngày bạn chọn không tồn tại";}
	}
